...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double h1 = 250 * (imagescardList.length) / 2;
    return Scaffold(
...
class imagecardgen extends StatelessWidget {
  final List<Map<String, dynamic>> imageData;

  const imagecardgen({super.key, required this.imageData});

  //imagecardgen({ this.imageData});
